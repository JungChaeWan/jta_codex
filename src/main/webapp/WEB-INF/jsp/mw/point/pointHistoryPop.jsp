...
<div class="point-header">
    <a href="javascript:close_popup($('.couponRegPop_1'));" class="btn-close">
        <img src="/images/mw/icon/close/faq_close.png" alt="닫기">
    </a>
    <h2>포인트 내역</h2>
</div>
                        ...
                        <strong>
                            <c:choose>
                                <c:when test="${phList.types eq 'USE'}">
                                    <a href="/mw/mypage/detailRsv.do?rsvNum=${phList.rsvNum}"> ${phList.corpNm}
