...
<header id="header">
	<jsp:include page="/mw/head.do" flush="false">
	  	...
	  	<jsp:param name="headTitle" value="판매약관"/>
	</jsp:include>
</header>
<!-- 헤더 e -->
<!-- 콘텐츠 s -->
...
<section id="subContent">
	...
	<div class="sub-content">
		<%-- <div id="tabs" class="detailTabMenu2 single">
            <ul class="menuList">
                <li><a href="<c:url value='/mw/etc/buyToS.do'/>" class="select">구매약관</a></li>
                <li><a href="" class="select">판매약관</a></li>
	        ...
	        <nav id="scroll_menuA" class="scroll-menuA not-padding">
	            <div class="scroll-area">
	                <ul>
		                ...
		                <li class="active"><a href="<c:url value='/mw/etc/saleToS.do'/>">판매약관</a></li>
		                <li><a href="<c:url value='/mw/etc/elBlank.do'/>">전자금융거래 이용약관</a></li>
	                </ul>
	            </div>
        ...
        <div class="rules-wrap">
			<dl class="comm-rule">
				<dt>제 1 조 (목적)</dt>
				<dd>
					본 약관은 제주특별자치도관광협회(이하 “회사”)와 회사가 운영하는 탐나오 사이트(http://www.tamnao.com, 이하 “탐나오”)에 판매자(본 약관에서 ‘판매자’는 탐나오 구매이용약관에 있는 ‘판매자’와 같음)로 입점하여 사이트에서 판매자에게 제공하는 전자상거래 관련 서비스와 기타 서비스(이하 “서비스”)를 이용하는 자 간의 권리, 의무를 확정하고 이를 이행하여 상호 발전을 도모하는 것을 목적으로 합니다.
				</dd>
				<dt>제 2 조 (용어의 정의)</dt>
				<dd>
