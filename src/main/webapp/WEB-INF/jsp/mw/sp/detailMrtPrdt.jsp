	...
	<div class="mw-detail-area">
						...
						<c:forEach var="coupon" items="${couponList}" varStatus="status">
							...
							<div class="row useCouponList" minAmt="${coupon.buyMiniAmt}">
								<span class="col1">
									...
									${coupon.cpNm}
									<br>
									<span class="text-gray">(<strong><fmt:formatNumber>${coupon.buyMiniAmt}</fmt:formatNumber>원</strong> 이상 구매시 사용 가능)</span>
								</span>
								<span class="col2">
				...
				<dd class="float">
					...
					<div class="r-area">
						<div class="type-body1">
							판매자명 : <c:out value="${prdtInfo.shopNm}" /><br>
		...
		<div class="purchase-area">
			...
			<div id="purchase_popup" class="purchase-popup">
				<button type="button" class="close" onclick="itemSingleHide('#purchase_popup');">
					<img src="/images/mw/icon/close/popup-close.png" alt="닫기">
				</button>
				...
				<div class="bottom-area">
				  	<div class="purchase-btn-group">
						<button type="button" class="red gobuy" style="width:94%;" onclick="fn_SpBuy();">바로구매</button>
					</div>
				</div>
			</div>
		</div> <!-- //purchase-area -->
		...
		<div id="sns_popup" class="sns-popup">
		    ...
		    <div class="sns-area">
		        <ul>
                    <li>
                        <a href="javascript:shareKakao('<c:out value="${webdtl.adNm}" />', '${imgUrl}', '${strUrl}'); snsCount('${prdtInfo.prdtNum}', 'MO', 'KAKAO');" id="kakao-link-btn">
                            <img src="/images/mw/icon/sns/kakaotalk.png" alt="카카오톡">
                            <span>카카오톡</span>
                        </a>
                    </li>
                    <li>
                        <a href="javascript:shareFacebook('${strUrl}'); snsCount('${prdtInfo.prdtNum}', 'MO' , 'FACEBOOK');">
                            <img src="/images/mw/icon/sns/facebook.png" alt="페이스북">
                            <span>페이스북</span>
                        </a>
                    </li>
                    <li>
                        <a href="javascript:shareStory('${strUrl}'); snsCount('${prdtInfo.prdtNum}', 'MO', 'KAKAO');">
                            <img src="/images/mw/icon/sns/kakaostory.png" alt="카카오 스토리">
                            <span>카카오 스토리</span>
                        </a>
                    </li>
                    <li>
		                <a href="javascript:shareBand('${strUrl}'); snsCount('${prdtInfo.prdtNum}', 'MO', 'BAND');">
		                    <img src="/images/mw/icon/sns/band.png" alt="네이버밴드">
		                    <span>네이버 밴드</span>
		                </a>
		            </li>
		            <li>
		                <a href="javascript:shareLine('${strUrl}'); snsCount('${prdtInfo.prdtNum}', 'MO', 'LINE');">
		                    <img src="/images/mw/icon/sns/line.png" alt="라인">
		                    <span>라인</span>
		                </a>
		            </li>
		        </ul>
	...
	function getCalOption() {
		...
		$.ajax({
			...
			success:function(data) {
				...
				//$("#calendar").css("display", "block");	//자동open 해제
