...
<meta name="robots" content="noindex">
	...
	function fn_edt(){
		...
		document.frm.action = "<c:url value='/web/cmm/edtBLOGproc.do'/>";
		document.frm.submit();
    ...
    <div class="popup-wrap">
    	<div class="blog-write">
    		...
    		<form name="frm" method="post" onSubmit="return false;" enctype="multipart/form-data">
    			<input type="hidden" name="blogLinkNum" value="<c:out value="${blogLinkNum}"/>">
    			<input type="hidden" name="prdtNum" value="<c:out value="${prdtNum}"/>">
    			<input type="hidden" name="corpCd" value="<c:out value="${corpCd}"/>">
    			<input type="hidden" name="blogImageLinkYn" value="${blogImageLinkYn}">
			...
			<div class="btn-wrap">
			    <button type="button" class="comm-btn red" onclick="fn_edt();">수정</button>
