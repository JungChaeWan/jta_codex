		...
		<li>
			<div class="user-info">
				...
				<c:if test="${userId eq cmt.userId}">
					<a href="javascript:fn_prmtCmtDelete('${cmt.cmtSn}')"><img src="/images/web/icon/del.gif" alt="삭제"></a>
				</c:if>
			</div>
			<div class="memo">
...
<c:if test="${fn:length(rmtCmtList) > 0}">          
	<div class="pageNumber">
		<p class="list_pageing"><ui:pagination paginationInfo="${paginationInfo}" type="web" jsFunction="fn_prmtCmtList" /></p>
	</div>
</c:if>