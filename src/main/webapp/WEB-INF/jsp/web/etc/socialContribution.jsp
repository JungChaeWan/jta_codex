...
<jsp:include page="/web/includeJs.do">
	<jsp:param name="title" value="제주여행 공공플랫폼 탐나오, 사회공헌"/>
    <jsp:param name="description" value="제주여행 공공플랫폼 탐나오 | 제주특별자치도관광협회 운영 사회공헌"/>
    <jsp:param name="keywords" value="실시간 항공,숙박,렌터카,관광지,맛집,여행사,레저,체험,특산기념품"/>
</jsp:include>
<meta property="og:title" content="제주여행 공공플랫폼 탐나오, 사회공헌">
<meta property="og:url" content="https://www.tamnao.com/web/etc/socialContribution.do">
<meta property="og:description" content="제주여행 공공플랫폼 탐나오 | 제주특별자치도관광협회 운영 사회공헌">
                		...
                		<div class="inner">
                			<div class="tbWrap">
                                ...
                                <div class="rContents smON">
                                    <h3 class="mainTitle">사회공헌</h3>
                                                                       
                                    <div class="socialCon">
                                    	<img src="<c:url value='/images/web/introduction/socialcon.jpg'/>" alt="인사말">
                                    </div> <!--//introduction-->
