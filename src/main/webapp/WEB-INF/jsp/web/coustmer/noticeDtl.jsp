                                ...
                                <div class="rContents smON">
                                    ...
                                    <div class="commBoard-wrap">
                                        <div class="board-view">
		                                                            ...
		                                                            <td>
		                                                                <ul class="viewFileList">
		                                                                	<c:forEach var="data" items="${notiFileList}" varStatus="status">
			                                                                    <li>
			                                                                        <img class="fileIcon" src="<c:url value='/images/web/board/file.png'/>" alt="첨부파일">
                                            ...
                                            <!-- button -->
                                            <div class="boardBT">
                                                <a href="<c:url value='/web/bbs/bbsList.do'/>?bbsNum=${notice.bbsNum}&pageIndex=${searchVO.pageIndex}&sKeyOpt=${searchVO.sKeyOpt}&sKey=${searchVO.sKey}&menuIndex=3">목록</a>
