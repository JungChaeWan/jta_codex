                    ...
                    <div class="inner">
                        <div class="tbWrap">
                            ...
                            <div class="rContents smON">
                                ...
                                <%--<a href='#' onclick='window.open("/web/cmm/insBLOG.do?prdtNum=C000000020&corpCd=AD","insblog", "width=600, height=700, scrollbars=yes, status=no, toolbar=no;");'>[test]</a>
                                <button type="button" class="comm-btn" onclick="window.open('/web/cmm/insBLOG.do?prdtNum=C000000020&corpCd=AD', 'insblog', 'width=600,height=700');">글쓰기</button> --%>
                                <div class="freqWrap">
                                    <!--
                                        <div class="freqSearch">
                                            <ul class="tbOption">
                                                ...
                                                <li class="list3 frBT">
                                                    <input type="image" src="<c:url value='/images/web/service/search.gif'/>" alt="검색">
                                                    <a href=""><img src="<c:url value='/images/web/service/question.gif'/>" alt="1:1문의"></a>
                                                </li>
                                            </ul>
                                            <ul class="tbOption">
                                                <li class="list1"></li>
                                        ...
                                        <div id="tabs-1" class="tabPanel">
                                            ...
                                            <dl class="default-accordion">
                                                ...
                                                <dd>
                                                    <ul class="question">
                                                        <li>
                                                            <p class="memo answer">
                                                                <b>[ 제이엘항공 ] <br />
                                                                   마이페이지 > 나의예약/구매내역 > 항공 제휴사 페이지 접속 > 예약확인 > 상세보기 > ‘취소’ 버튼클릭 > 취소 관련 내용 확인 후 ‘확인’ 버튼클릭</b></p>
                                                            ...
                                                            <br /><%--<br /><br />
                                                            <b>[ 제주닷컴 ]<br />
                                                               마이페이지 > 나의예약/구매내역 > 항공 제휴사 페이지 접속 > 예약확인 > 상세내역보기 > ‘예약/결제취소’ 버튼 클릭 > 수수료 관련 내용 확인 후 ‘예약/결제취소’ 버튼 한 번 더 클릭</b>
                                                            <img src="/images/web/faq/jeju111.png" width="770"/>
                                                            <img src="/images/web/faq/jeju222.png" width="770"/>
                                                            <img src="/images/web/faq/jeju333.png" width="770"/>--%>
                                                        </li>
                                                    </ul>
                                                </dd>
                                                <dt>
                                                ...
                                                <dd>
                                                    <ul class="question">
                                                        <li>
                                                            <p class="memo answer">취소 수수료는 항공사마다 규정이 다르며, 성인/소아 동일하게 적용됩니다.<br><br>
                                                            <span class="text--set0">01. 대한항공</span>
                                                            <span class="text--set1">
                                                            - 구매 익일 ~ 출발 1시간 전 : 일반석 편도 3,000원 / 할인석 편도 5,000원 / 특가석 편도 7,000원<br>
                                                            - 출발 1시간 전 ~ 출발시간 이후 : 일반석 편도 11,000원 / 할인석 편도 13,000원 / 특가석 편도 15,000원
                                                            </span>
                                                            <span class="text--set0">02. 아시아나항공</span>
                                                            <span class="text--set1">
                                                            - 비즈니스석, 일반석(구매 익일 ~ 출발 20분 전) : 편도 3,000원<br>
                                                            - 할인석(구매 익일 ~ 출발 20분 전) : 편도 8,000원<br>
                                                            - 특가석(구매 익일 ~ 출발 20분 전) : 편도 12,000원<br>
                                                            - 출발시간 이후(NO-SHOW) : 편도 15,000원
                                                            </span>
                                                            <span class="text--set0">03. 티웨이항공</span>
                                                            <%-- <span class="text--set2">* 일반석, 할인석</span>--%>
                                                            <span class="text--set1">
                                                            ...
                                                            <span class="text--set2">* 특가석</span>
                                                                - 구매 익일 ~ 당일 출발 전 : 변경-편도 15,000원 / 취소-운임의 100% 징수<br>
                                                                - 당일 출발 이후(NO-SHOW) : 운임의 100% 징수
                                                            </span>
                                                            </span>
                                                            <span class="text--set0">04. 진에어</span>
                                                            <span class="text--set1">
                                                            - 구매 익일 ~ 출발 61일 전 : 일반석 편도 1,000원 / 할인석 편도 2,000원 / 특가석 편도 3,000원<br>
                                                            - 60일 전 ~ 31일 전 : 일반석 편도 3,000원 / 할인석 편도 4,000원 / 특가석 편도 5,000원<br>
                                                            - 30일 전 ~ 15일 전 : 일반석 편도 4,000원 / 할인석 편도 6,000원 / 특가석 편도 7,000<br>
                                                            - 14일 전 ~ 2일 전 : 일반석 편도 8,000원 / 할인석 편도 9,000원 / 특가석 편도 10,000<br>
                                                            - 1일 전 ~ 출발 시간 전 : : 일반석 편도 10,000원 / 할인석 편도 12,000원 / 특가석 편도 14,000원<br>
                                                            - 출발 시간 이후 : 일반석, 할인석, 특가석 편도 15,000원
                                                            </span>
                                                            <span class="text--set0">05. 제주항공</span>
                                                            <span class="text--set1">
                                                            ...
                                                            - 출발 당일(출발 1시간 이내 ~ NO-SHOW 포함) : 일반석, 할인석, 특가석, 비즈니스석 편도 15,000원
                                                            </span>
                                                            <span class="text--set0">06. 에어부산</span>
                                                            <span class="text--set1">
                                                            ...
                                                            - 출발 1시간 이내 ~ 출발 시간 이후(NO-SHOW) : 일반석, 할인석, 특가석 편도 15,000원
                                                            </span>
                                                            <span class="text--set0">07. 에어서울</span>
                                                            <span class="text--set1">
                                                            - 구매 익일 ~ 출발 61일 전 : 일반석 편도 1,000원 / 할인석, 특가석 편도 2,000원<br>
                                                            ...
                                                            <span class="text--set2">* 특가석(A)</span>
                                                            - 구매 익일 ~ 출발시간 이후(NO-SHOW) : 편도 15,000원
                                                            </span>
                                                            <span class="text--set0">08. 이스타항공</span>
                                                            <span class="text--set1">
                                                ...
                                                <dt>
                                                    <ul class="tbOption">
                                                        ...
                                                        <li class="memoWrap">
                                                            <p class="memo">할인석과 일반석이 차이는 무엇인가요?</p>
                                                        </li>
                                                    </ul>
                                                </dt>
                                                <dd>
...
<%--                                                        <li class="number">3</li>--%>
<%--                                                        <li class="memoWrap">--%>
<%--                                                            <p class="memo">구매한 상품을 취소한 경우 쿠폰 환불은 어떻게 되나요?</p>--%>
<%--                                                        </li>--%>
<%--                                                    </ul>--%>
<%--                                                </dt>--%>
<%--                                                <dd>--%>
<%--                                                    <ul class="question">--%>
<%--                                                        <li>--%>
<%--                                                            <p class="memo answer">구매한 상품을 취소한 경우 탐나오 쿠폰도 함께 환원을 시켜드립니다.</p>--%>
<%--                                                        </li>--%>
<%--                                                    </ul>--%>
<%--                                                </dd>--%>
<%--                                                <dt>--%>
...
<%--                                                        <li class="number">2</li>--%>
<%--                                                        <li class="memoWrap">--%>
<%--                                                            <p class="memo">탐나오 쿠폰 사용방법은 어떻게 되나요?</p>--%>
<%--                                                        </li>--%>
<%--                                                    </ul>--%>
<%--                                                </dt>--%>
<%--                                                <dd>--%>
<%--                                                    <ul class="question">--%>
<%--                                                        <li>--%>
<%--                                                            <p class="memo answer">상품예약페이지 [적용가능쿠폰]에서 선택하여 이용이 가능합니다. 탐나오 쿠폰은 현금으로 환불되지 않습니다.</p>--%>
<%--                                                        </li>--%>
<%--                                                    </ul>--%>
<%--                                                </dd>--%>
<%--                                                <dt>--%>
...
<%--                                                        <li class="number">1</li>--%>
<%--                                                        <li class="memoWrap">--%>
<%--                                                            <p class="memo">탐나오 쿠폰은 어떻게 발행받을 수 있나요?</p>--%>
<%--                                                        </li>--%>
<%--                                                    </ul>--%>
<%--                                                </dt>--%>
<%--                                                <dd>--%>
<%--                                                    <ul class="question">--%>
<%--                                                        <li>--%>
<%--                                                            <p class="memo answer">최초 회원가입 시 다양한 할인 쿠폰을 제공해드립니다.</p>--%>
<%--                                                        </li>--%>
<%--                                                    </ul>--%>
<%--                                                </dd>--%>
<%--                                            </dl>--%>
<%--                                        </div> <!-- 탐나오쿠폰(tabs-7) -->--%>
                                        ...
                                        <script>
                                            ...
                                            $('#tabs ul li a').eq(${cate-1}).trigger( "click" );
                                        </script>
                                    </div> <!--//tabs-->
                                </div>
                                <!--페이지 번호-->
                                <%-- <div class="pageNumber">
                                    <p class="floatWrap">
                                        <span class="page_first"><a href=""><img src="<c:url value='/images/web/icon/page1.gif'/>" alt="처음"></a></span>
                                        <span class="page_prev"><a href=""><img src="<c:url value='/images/web/icon/page2.gif'/>" alt="이전"></a></span>
                                        ...
                                        <span class="page_next"><a href=""><img src="<c:url value='/images/web/icon/page3.gif'/>" alt="다음"></a></span>
                                        <span class="page_last"><a href=""><img src="<c:url value='/images/web/icon/page4.gif'/>" alt="끝"></a></span>
                                    </p>
                                </div> <!--//pageNumber--> --%>
                            </div> <!--//rContents-->
                        </div> <!--//tbWrap-->
