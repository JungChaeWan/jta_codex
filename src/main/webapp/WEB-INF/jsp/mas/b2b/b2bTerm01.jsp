			...
			<div id="contents">
				...
				<div class="max-wrap">
	                <div class="title-info">
	                	<h3 class="title">B2B 판매대행계약 이용약관 (개별 실시간 관광사업체)</h3>
	                </div>
					...
					<div class="btn-wrap1">
						<a class="btn blue big disabled" id="btnReg" onclick="fn_Reg();" disabled="disabled">등록</a>
						<!-- <button type="button" class="btn blue big disabled" disabled="disabled">등록</button> -->
					</div>
			    </div>
                <!-- //change contents -->		
			</div>			
