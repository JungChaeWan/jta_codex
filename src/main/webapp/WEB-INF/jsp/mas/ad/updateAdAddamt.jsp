...
function fn_Udt(){
	...
	document.AD_ADDAMTVO.action = "<c:url value='/mas/ad/updateAdAddamt.do' />";
	document.AD_ADDAMTVO.submit();
}

function fn_Del(){
	if(confirm("<spring:message code='common.delete.msg'/>")){
		document.AD_ADDAMTVO.action = "<c:url value='/mas/ad/deleteAdAddamt.do' />";
		document.AD_ADDAMTVO.submit();
	}
}
			...
			<div id="contents">
				<form:form commandName="AD_ADDAMTVO" name="AD_ADDAMTVO" method="post">
					<div class="register_area">
						<h4 class="title03">인원 추가요금(공통) 수정<span style="float:right"><span class="font_red">*</span> 필수 입력 항목입니다.</span></h4>
				...
				<ul class="btn_rt01">
					...
					<li class="btn_sty03"><a href="javascript:fn_Del()">삭제</a></li>
