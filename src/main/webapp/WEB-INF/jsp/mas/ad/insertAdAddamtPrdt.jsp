...
function fn_Ins(){
	...
	document.AD_ADDAMTVO.action = "<c:url value='/mas/ad/insertAdAddamtPrdt.do' />";
			...
			<div id="contents">
				<form:form commandName="AD_ADDAMTVO" name="AD_ADDAMTVO" method="post">
					...
					<div class="register_area">
						<h4 class="title03">인원 추가요금<span style="float:right"><span class="font_red">*</span> 필수 입력 항목입니다.</span></h4>
