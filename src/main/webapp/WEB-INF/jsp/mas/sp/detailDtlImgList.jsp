...
function fn_ListPrdt(){
	document.tabForm.action = "<c:url value='/mas/sps/productList.do'/>";
	...
	<div id="contents_wrapper">
		<div id="contents_area">
			<div id="contents">
	            ...
	            <!--본문-->
	            <!--상품 등록-->
	             <jsp:include page="/mas/cmm/detailDtlImgList.do?linkNum=${spPrdtInf.prdtNum}" flush="false"></jsp:include>
	            <!--//상품등록-->
	            <!--//본문-->
	        </div>
		</div>
