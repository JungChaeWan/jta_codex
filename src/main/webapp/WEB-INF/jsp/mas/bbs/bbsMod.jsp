...
/* 	if(document.frm.writer.value.length==0){
	...
	document.frm.action = "<c:url value='/mas/bbs/bbsMod.do'/>";
	document.frm.submit();
}
...
function fn_delFile(id){
	if(confirm("첨부파일은 바로 삭제 되어 복구 할수 없습니다.\n삭제 하시겠습니까?")){
		...
		document.frm.action = "<c:url value='/mas/bbs/bbsDelFile.do'/>";
		document.frm.submit();
	}
}
	...
	<div id="contents_wrapper">
		...
		<div id="contents_area"> 
			...
			<ul class="btn_rt01">
				...
				<li class="btn_sty01">
					<a href="<c:url value='/mas/bbs/bbsDtl.do'/>?bbsNum=${notice.bbsNum}&noticeNum=${notice.noticeNum}&pageIndex=${searchVO.pageIndex}&sKeyOpt=${searchVO.sKeyOpt}&sKey=${searchVO.sKey}">취소</a>
				</li>
			</ul>
