                                ...
                                <tr>
                                    <th rowspan="4">
                                        <div class="rese-number">
											...
											<div class="btn-wrap">
												<p><a href="javascript:fn_DetailRsv('${rsvInfo.adRsvNum}')" class="btn white">상세보기</a></p>
											</div>
                                        </div>
                                    </th>
                                    <td>
                                        <dl class="rese-detail">
                                            ...
                                            <dd>
												...
												<p><fmt:formatDate value="${useDt}" pattern="yyyy-MM-dd"/> ~ ${rsvInfo.useNight}박 성인 ${rsvInfo.adultNum}명, 소인 ${rsvInfo.juniorNum}명, 유아 ${rsvInfo.childNum}명</p>
                                            </dd>
                                        </dl>
                                    </td>
                                </tr>
