...
<meta charset="UTF-8">
	...
	function fn_CancelRsvReq(){
		if(confirm("취소 하시겠습니까?")){
			...
			var parameters = "rsvNum=${resultVO.rsvNum}&rcRsvNum=${resultVO.rcRsvNum}&payDiv=${resultVO.payDiv}&cmssAmt=" + $("#cmssAmt").val()+"&cancelInf=" + $("#cancelInf").val();
			$.ajax({
				type:"post", 
				dataType:"json",
				async:false,
