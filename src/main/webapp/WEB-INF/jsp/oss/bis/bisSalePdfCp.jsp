...
function fn_Search(corpNm){	
	...
	document.frm.action = "<c:url value='/oss/bisSalePdfCp.do'/>";
	document.frm.submit();
}
...
var buy_cnt_config = {
	    ...
	    data: {
	        datasets: [{
	            data: [<c:forEach items="${couponBuyCntPer }" var="per">${per.rsvCntPer},</c:forEach>],
	            backgroundColor: lebels_bgcolors,
	        }],
	        labels: [<c:forEach items="${couponBuyCntPer }" var="per">"${per.prdtNm}",</c:forEach>]
	    },
	    options: {
	        responsive: false,
	        legend: {
            ...
            <!-- change contents -->
                ...
                <div id="menu_depth3">
					<ul>
						...
						<li><a class="menu_depth3" href="/oss/bisSalePdfSpc.do">관광지</a></li>
						<li><a class="menu_depth3" href="/oss/bisSalePdfSpf.do">음식/뷰티</a></li>
						<li><a class="menu_depth3" href="/oss/bisSalePdfSpt.do">패키지</a></li>
						<li><a class="menu_depth3" href="/oss/bisSalePdfSv.do">기념품</a></li>
						<li><a class="menu_depth3" href="/oss/bisSalePdfSpb.do">카시트/유모차</a></li>
						<li class="on"><a class="menu_depth3" href="/oss/bisSalePdfCp.do">하이제주</a></li>
					</ul>
				</div>
			    ...
			    <div class="search-value2">
			    	...
			    	<table class="table01">
				        ...
				        <tbody>
				            <tr>
				                <th>총 매출액</th>
				                <%--<td class="right"><fmt:formatNumber value="${prdtRsvAmt.totalRsvAmt }" /> 원</td>--%>
				                <th>총 취소금액</th>
			    ...
			    <div class="chart-form">			        
			        <div class="item">
            			...
            			<ul class="chart-caption">
			                <c:forEach var="info" items="${couponBuyCntPer }" varStatus="state">
			                <li class="area">
