...
function fn_InsPointJoin(){
	document.EVNTPOINTMNGVO.action = "<c:url value='/oss/event/insertProcVoucherMng.do'/>";
	document.EVNTPOINTMNGVO.submit();
}
				...
				<form id="EVNTPOINTMNGVO" name="EVNTPOINTMNGVO" method="post">
					...
					<table border="1" class="table02">
	                    ...
	                    <tr>
	                    	...
	                    	<td>
	                    		<input type="text" class="input_text10" name="vcNm" id="vcNm" />
	                    	</td>
	                    </tr>
	                    <tr>
	                    	<th scope="row">시작일</th>
	                    	<td>
	                    		<input type="text" class="input_text10" name="exprStartDt" id="exprStartDt" />
	                    	</td>
	                    </tr>
						<tr>
							<th scope="row">종료일</th>
							<td>
								<input type="text" class="input_text10" name="exprEndDt" id="exprEndDt" />
							</td>
						</tr>
						<tr>
							<th scope="row">설명</th>
							<td>
								<input type="text" class="input_text10" name="vcExp" id="vcExp" />
							</td>
						</tr>
					</table>
