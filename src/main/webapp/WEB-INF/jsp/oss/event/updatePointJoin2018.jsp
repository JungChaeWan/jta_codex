...
function fn_InsPointJoin(){
	document.EVNTPOINTMNGVO.action = "<c:url value='/oss/event/updatePointJoin2018.do'/>";
		...
		<div id="contents_area"> 
			...
			<div id="contents">
				...
				<form id="EVNTPOINTMNGVO" name="EVNTPOINTMNGVO" method="post">
					...
					<input type="hidden" id="mngNum" name="mngNum" value="${EVNTPOINTMNGVO.mngNum}" />
					...
					<table border="1" class="table02">
	                    ...
	                    <tr>
	                    	...
	                    	<td>
	                    		<input type="text" class="input_text10" name="userNm" id="userNm" value="${EVNTPOINTMNGVO.userNm}" />
	                    	</td>
	                    </tr>
	                    <tr>
	                    	<th scope="row">사용자아이디</th>
	                    	<td>
	                    		<input type="text" class="input_text10" name="userId" id="userId" value="${EVNTPOINTMNGVO.userId}"  />
	                    	</td>
	                    </tr>
	                    <tr>
	                    	<th scope="row">전화번호</th>
	                    	<td>
	                    		<input type="text" class="input_text10" name="telNum" id="telNum" value="${EVNTPOINTMNGVO.telNum}"  />
	                    	</td>
	                    </tr>
	                    <tr>
	                    	<th scope="row">적용포인트</th>
	                    	<td>
	                    		<input type="text" class="input_text10" name="aplPoint" id="aplPoint" value="${EVNTPOINTMNGVO.aplPoint}"  />
	                    	</td>
	                    </tr>
					</table>
