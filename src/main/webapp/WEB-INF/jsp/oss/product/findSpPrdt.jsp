...
function fn_Search(pageIndex) {
	...
	document.frm.action = "<c:url value='/oss/findSpPrdt.do'/>";
...
<div id="popup_wrapper">
    <div id="popup_contents">
        ...
        <div class="search_area">
        	...
        	<input type="hidden" name="sCtgr" value="<c:out value='${searchVO.sCtgr}'/>"/>
        	<input type="hidden" name="sSubCtgr" value="<c:out value='${searchVO.sSubCtgr}'/>"/>
        	<input type="hidden" name="sAreaCd" value="<c:out value='${searchVO.sAreaCd}'/>"/>
                                ...
                                <div style="height:400px; overflow:auto;">
                                    <table width="100%" border="1" class="table01 list_tb">
                                        ...
                                        <tr>
                                            ...
                                            <td>${data.prdtNm}</td>
                                            <td>
                                                <c:if test="${Constant.SP_PRDT_DIV_TOUR eq data.prdtDiv}">여행상품</c:if>
                                                <c:if test="${Constant.SP_PRDT_DIV_COUP eq data.prdtDiv}">쿠폰상품</c:if>
                                                <c:if test="${Constant.SP_PRDT_DIV_FREE eq data.prdtDiv}">무료쿠폰</c:if>
                                                <c:if test="${Constant.SP_PRDT_DIV_SHOP eq data.prdtDiv}">쇼핑상품</c:if>
                                            </td>
                                            <td>
                                                <div class="btn_sty06">
