...
function fn_Udt() {
	...
	*/
	...
	document.frm.action ="<c:url value='/oss/cardivUdt.do'/>";
	document.frm.submit();
}
	...
	<div id="contents_wrapper">
		...
		<div id="contents_area">
			...
			<form name="frm" id="frm" method="post" enctype="multipart/form-data">
				<input type="hidden" name="sMakerDiv" value="${searchVO.sMakerDiv}" />
				<input type="hidden" name="sCarDiv" value="${searchVO.sCarDiv}" />
				<input type="hidden" name="sUseFuelDiv" value="${searchVO.sUseFuelDiv}" />
				<input type="hidden" name="sPrdtNm" value="${searchVO.sPrdtNm}" />
				<input type="hidden" name="sRcCardivNum" value="${searchVO.sRcCardivNum}" />
				<input type="hidden" name="sUseYn" value="${searchVO.sUseYn}" />
				<input type="hidden" name="pageIndex" value="${searchVO.pageIndex}" />

				<div id="contents">
					<h4 class="title03">차종 수정<span style="float:right"><span class="font_red">*</span> 필수 입력 항목입니다.</span></h4>
					...
					<table class="table02">
						...
						<tr>
							<th>차량코드</th>
							<td>
								<input type="text" name="rcCardivNum" id="rcCardivNum" class="input_text10" maxlength="10" value="${RC_CARDIVVO.rcCardivNum}" readonly="readonly"/>
							</td>
						</tr>
						<tr>
							<th>차량명<span class="font_red">*</span></th>
							<td>
								<input type="text" name="prdtNm" id="prdtNm" class="input_text20" maxlength="30" value="${RC_CARDIVVO.prdtNm}"/><br>
						...
						<tr>
							<th>차량설명</th>
							<td>
								<input type="text" name="cardivExp" id="cardivExp"  class="input_text50" maxlength="100" value="${RC_CARDIVVO.cardivExp}"/><br>
						...
						<tr>
							...
							<td>
								<select id="makerDiv" name="makerDiv">
						...
						<tr>
							...
							<td>
								<select id="useFuelDiv" name="useFuelDiv">
						...
						<tr>
							...
							<td>
								<img src="<c:url value='${RC_CARDIVVO.carImg}'/>" style="max-height: 300px;" alt="${RC_CARDIVVO.prdtNm}" /><br>
								...
								<input type="hidden" name="carImg" id="carImg" value='${RC_CARDIVVO.carImg}' />
							</td>
						</tr>
						<tr>
							<th>검색어</th>
							<td>
								<p>
									<input type="text" name="srchWord1" id="srchWord1" maxlength="30" value="${RC_CARDIVVO.srchWord1}" />
									<input type="text" name="srchWord2" id="srchWord2" maxlength="30" value="${RC_CARDIVVO.srchWord2}" />
									<input type="text" name="srchWord3" id="srchWord3" maxlength="30" value="${RC_CARDIVVO.srchWord3}" />
									<input type="text" name="srchWord4" id="srchWord4" maxlength="30" value="${RC_CARDIVVO.srchWord4}" />
									<input type="text" name="srchWord5" id="srchWord5" maxlength="30" value="${RC_CARDIVVO.srchWord5}" />
								</p>
								<p>
									<input type="text" name="srchWord6" id="srchWord6" maxlength="30" value="${RC_CARDIVVO.srchWord6}" />
									<input type="text" name="srchWord7" id="srchWord7" maxlength="30" value="${RC_CARDIVVO.srchWord7}" />
									<input type="text" name="srchWord8" id="srchWord8" maxlength="30" value="${RC_CARDIVVO.srchWord8}" />
									<input type="text" name="srchWord9" id="srchWord9" maxlength="30" value="${RC_CARDIVVO.srchWord9}" />
									<input type="text" name="srchWord10" id="srchWord10" maxlength="30" value="${RC_CARDIVVO.srchWord10}" />
								</p>
							</td>
						</tr>
						<tr>
