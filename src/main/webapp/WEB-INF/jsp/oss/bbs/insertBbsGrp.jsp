...
function fn_Ins(){
	...
	document.BBSGRPINFVO.action = "<c:url value='/oss/insertBbsGrp.do' />";
				...
				<div class="register_area">
					...
					<table border="1" class="table02">
	                    ...
	                    <tr>
	                    	...
	                    	<th>번호<span>*</span></th>
	                    	<td>
	                    		<form:input path="bbsGrpNum" id="bbsGrpNum" value="${bbs.bbsGrpNum}" class="input_text10" placeholder="ID를 입력하세요." maxlength="10" style="ime-mode:disabled;" />
	                    		<form:errors path="bbsGrpNum"  cssClass="error_text" />
	                    	</td>
	                    	 -->
	                    </tr>
	                   	<tr>                    	
