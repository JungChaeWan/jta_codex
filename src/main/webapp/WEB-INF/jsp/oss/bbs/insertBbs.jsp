...
function fn_Ins(){
	...
	document.BBSVO.action = "<c:url value='/oss/insertBbs.do' />";
			...
			<div id="contents">
				<div class="register_area">
					...
					<table border="1" class="table02">
	                    ...
	                    <tr>
	                    	<th>ID<span class="font02">*</span></th>
	                    	<td colspan="3">
	                    		<form:input path="bbsNum" id="bbsNum" value="${bbs.bbsNum}" class="input_text10" placeholder="ID를 입력하세요." maxlength="10" style="ime-mode:disabled;" />
