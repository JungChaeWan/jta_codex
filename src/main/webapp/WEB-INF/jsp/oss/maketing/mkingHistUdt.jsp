...
function fn_Ins() {
	...
	document.frm.action ="<c:url value='/oss/mkingHistUdt.do'/>";
	document.frm.submit();
}
	...
	<div id="contents_wrapper">
		...
		<div id="contents_area">
			...
			<form:form commandName="frm" name="frm" method="post" enctype="multipart/form-data">
				...
				<div id="contents">
					<h4 class="title03">마케팅 이력 수정<span style="float:right"><span class="font_red">*</span> 필수 입력 항목입니다.</span></h4>
					...
					<table border="1" class="table02">
						...
						<tr>
							...
							<td>
								<input type="text" name="mkingDt" id="mkingDt"  class="input_text5" readonly="true"  value="${fn:substring(MKINGHISTVO.mkingDt,0,4)}-${fn:substring(MKINGHISTVO.mkingDt,4,6)}-${fn:substring(MKINGHISTVO.mkingDt,6,8)}" />
							</td>
							<th>진행매체</th>
							<td>
						...
						<tr>
							...
							<td >
								<input type="text" name="stdStartDttm" id="stdStartDttm"  class="input_text5" readonly="true"  value="${fn:substring(MKINGHISTVO.stdStartDttm,0,4)}-${fn:substring(MKINGHISTVO.stdStartDttm,4,6)}-${fn:substring(MKINGHISTVO.stdStartDttm,6,8)}" />
								~
								<input type="text" name="stdEndDttm" id="stdEndDttm"  class="input_text5" readonly="true"  value="${fn:substring(MKINGHISTVO.stdEndDttm,0,4)}-${fn:substring(MKINGHISTVO.stdEndDttm,4,6)}-${fn:substring(MKINGHISTVO.stdEndDttm,6,8)}" />
							</td>
						</tr>
