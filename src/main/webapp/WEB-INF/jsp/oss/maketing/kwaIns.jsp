...
function fn_Ins() {
	...
	document.frm.action ="<c:url value='/oss/kwaIns.do'/>";
	document.frm.submit();
}
	...
	<div id="contents_wrapper">
		...
		<div id="contents_area">
			...
			<form:form name="frm" method="post" enctype="multipart/form-data">
				...
				<div id="contents">
					<h4 class="title03">해시태그 광고 등록<span style="float:right"><span class="font_red">*</span> 필수 입력 항목입니다.</span></h4>
					<table border="1" class="table02">
						...
						<tr>
							...
							<td>
								<input type="text" name="startDttm" id="startDttm"  class="input_text5" readonly="true"  value="${KWAVO.startDttm}" />
							</td>
							<th>종료일<span class="font_red">*</span></th>
							<td>
								<input type="text" name="endDttm" id="endDttm"  class="input_text5" readonly="true" value="${KWAVO.endDttm}" />
								<div class="btn_sty04">
