...
public class WebAuthGuestInterceptor extends HandlerInterceptorAdapter {
	...
	//Logger log = (Logger) LogManager.getLogger("aaa");
...
//								rtnParameter += s_param[j];
				...
				String returnUrl = "redirect:/web/viewLogin.do?rtnUrl=" + servletPath
				         	+ rtnParameter;
