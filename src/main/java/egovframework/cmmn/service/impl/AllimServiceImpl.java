...
import egovframework.cmmn.service.AllimService;

@Service("allimService")
public class AllimServiceImpl implements AllimService {
	
	/** AllimDAO */
    @Resource(name="AllimDAO")
	...
	public void sendTemplet10001(Map<String, Object> paramMap){
    	AllimDAO.sendTemplet10001(paramMap);
    }
	...
	public void sendTemplet10003(Map<String, Object> paramMap){
    	AllimDAO.sendTemplet10003(paramMap);
    }
}
