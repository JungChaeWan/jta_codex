...
@Service("ossAnlsService")
public class OssAnlsServiceImpl extends EgovAbstractServiceImpl implements OssAnlsService {

//	private static final Logger LOGGER = LoggerFactory.getLogger(MasRcPrdtServiceImpl.class);

	@Resource(name = "ossAnlsDAO")
	private OssAnlsDAO ossAnlsDAO;
	...
	public List<ANLSVO> selectAnls02(ANLSSVO anlsSVO){
		return ossAnlsDAO.selectAnls02(anlsSVO);
	}
	...
	public List<ANLSVO> selectSpAnls02Dtl(ANLSSVO anlsSVO){
		return ossAnlsDAO.selectSpAnls02Dtl(anlsSVO);
	}
	...
	public ANLS05VO selectJoinAnls(ANLSSVO anlsSVO){
		return ossAnlsDAO.selectJoinAnls(anlsSVO);
	}
	...
	public List<ANLS06VO> selectAnls06(ANLSSVO anlsSVO){
		return ossAnlsDAO.selectAnls06(anlsSVO);
	}
	...
	public ANLS07VO selectAnls04(ANLSSVO anlsSVO){
		return ossAnlsDAO.selectAnls04(anlsSVO);
	}
	...
	public ANLS08VO selectCancelAnls04(ANLSSVO anlsSVO){
		return ossAnlsDAO.selectCancelAnls04(anlsSVO);
	}
	...
	public List<ANLS05VO> selectAnls09(ANLSSVO anlsSVO){
		return ossAnlsDAO.selectAnls09(anlsSVO);
	}
	...
	public ANLS10VO selectAnls10(){
		return ossAnlsDAO.selectAnls10();
	}
	...
	public List<ANLS11VO> selectAnls11(ANLSSVO anlsSVO){
		return ossAnlsDAO.selectAnls11(anlsSVO);
	}
}
