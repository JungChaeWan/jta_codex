...
public class StringEncrypter {
	...
	public String encrypt(String value) throws Exception {
		...
		return modules.utils.Base64Encoder.encode(encryptedValue);
	}
	...
	public String decrypt(String value) {
		try {
			...
			byte[] encryptedValue = modules.utils.Base64Encoder.decode(value);
	...
	public String sha256(String value) throws Exception{
		...
		return modules.utils.Base64Encoder.encode(digestByte);
	}
